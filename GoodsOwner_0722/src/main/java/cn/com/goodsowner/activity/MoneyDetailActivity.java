...
public class MoneyDetailActivity extends BaseActivity {
    ...
    protected void initView() {
        ...
        if (freight > 0) {
            ...
            tv_freight.setText(String.format("¥%.2f", freight));
        } else {
        ...
        if (IsSurcharge > 0) {
            ...
            tv_freight.setText(String.format("¥%.2f", IsSurcharge));
        } else {
        ...
        if (amount > 0) {
            ...
            tv_freight.setText(String.format("¥%.2f", amount));
        }
