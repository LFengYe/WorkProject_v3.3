...
import com.guugoo.jiapeistudent.MainActivity.MainActivity;
...
public class MyReceiver extends BroadcastReceiver {
	...
	private void progressNotaFicationData(Context context, String string) {
		...
		switch (type) {
			case 5:
				((MyApplication)context.getApplicationContext()).locationService.start();
				/*
				//打开主界面
				...
				*/
			case 3:
				((MyApplication)context.getApplicationContext()).locationService.stop();
				/*
				//打开主界面
