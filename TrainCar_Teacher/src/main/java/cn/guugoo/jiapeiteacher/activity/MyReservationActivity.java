        ...
        switch (i) {
            case 0:
                ...
                if (fg_total == null) {
                    ...
                    fg_total = ReservationFragment.newInstance(teacherId,0,token);
            ...
            case 1:
                ...
                if (fg_has_reservation == null) {
                    fg_has_reservation = ReservationFragment.newInstance(teacherId,1,token);
            ...
            case 2:
                ...
                if (fg_pending_payment == null) {
                    fg_pending_payment = ReservationFragment.newInstance(teacherId,2,token);
            ...
            case 3:
                ...
                if (fg_has_ended == null) {
                    ...
                    fg_has_ended = ReservationFragment.newInstance(teacherId,3,token);
