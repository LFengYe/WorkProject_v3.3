...
import cn.com.caronwer.bean.InvoiceInfo;
...
public class InvoiceInfoAdapter extends RecyclerView.Adapter<InvoiceInfoAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_my_invoice, viewGroup, false);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            cb_order = (CheckBox) view.findViewById(R.id.cb_order);
            tv_money = (TextView) view.findViewById(R.id.tv_money);
            tv_time = (TextView) view.findViewById(R.id.tv_time);
            tv_start = (TextView) view.findViewById(R.id.tv_start);
            tv_arrive = (TextView) view.findViewById(R.id.tv_arrive);
