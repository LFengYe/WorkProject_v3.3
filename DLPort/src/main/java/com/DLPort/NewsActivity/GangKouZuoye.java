 ...
 */
public class GangKouZuoye extends BaseActivity{
    private int currentPage =1;
    private static final String TAG="GangKouZuoye";
            ...
            if (msg.what == 1) {
                try {
                    ...
                    if (0 == status) {
                        ...
                        MyToast.makeText(GangKouZuoye.this, "获取失败");
                    }
                ...
                MyToast.makeText(GangKouZuoye.this, msg.what+" 服务器异常");
            }
        }
    };
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gangkou_zuoye);
        initTitle();
        init();
    }
    private void init() {
        listView = (ListView) findViewById(R.id.zuoye_list);


        if(GlobalParams.isNetworkAvailable(GangKouZuoye.this)) {
            ...
            new MyThread(Constant.URL_PostGetzuoye,handler,json,GangKouZuoye.this).start();

        } else{
            MyToast.makeText(GangKouZuoye.this, "亲,网络未连接");
        }

    }

    private void initTitle() {
        TitleView titleView = (TitleView) findViewById(R.id.gangkouzuoye_title);
        titleView.setLeftViewVisible(true);
        titleView.setMiddleTextVisible(true);
        titleView.setWineText(R.string.news1);
        titleView.setMiddleText(R.string.zuoye);
    ...
    public void pullUnOrderList (JSONObject obj) {
        ...
        try {
            ...
            adapter = new ArrayAdapter<String>(GangKouZuoye.this,R.layout.text,Str);
