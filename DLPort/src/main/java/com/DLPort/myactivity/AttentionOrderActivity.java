 ...
 * 关注订单
 */
public class AttentionOrderActivity extends BaseActivity {
    private static final String TAG="AttentionOrderActivity";
    ...
    private Handler handler =new MyHandler(this) {
        ...
        public void handleMessage(Message msg) {
            ...
            if(msg.what ==1) {
                ...
                try {
                    ...
                    if (status == 0) {
                        ...
                        if (json.getString("Cargos").equals("[]")){
                            isCompleated = true;
                            MyToast.makeText(AttentionOrderActivity.this, "暂时没有抢单记录");
                            switch (requestType){
                                case 1:
                        ...
                        MyToast.makeText(AttentionOrderActivity.this, "亲、目前没有订单");
                        switch (requestType){
                            case 1:
                                recordPullToRefreshLayout
                                        .refreshFinish(PullToRefreshLayout.SUCCEED);
                ...
                isCompleated = true;
                MyToast.makeText(AttentionOrderActivity.this, msg.what + "服务器异常");
                switch (requestType){
                    case 1:
...
//        initOrders();
        ...
        xiala.setOnRefreshListener(new PullToRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh(PullToRefreshLayout pullToRefreshLayout) {
                ...
                if (GlobalParams.isNetworkAvailable(AttentionOrderActivity.this)) {
                    if (isCompleated) {
                        mlist.clear();
                        adapter.notifyDataSetChanged();
                        currentPage = 1;
                        ...
                        Toast.makeText(AttentionOrderActivity.this, "亲,请连接网络！！！", Toast.LENGTH_SHORT)
                                .show();
                    }
                } else {
                    isCompleated = true;
