...
import com.guugoo.jiapeiteacher.adapter.EvaluateListAdapter;
...
public class StudentDetailsActivity extends BaseActivity implements Chronometer.OnChronometerTickListener {
    ...
    public void onChronometerTick(Chronometer chronometer) {
        ...
        if ((CalculationTime % 10) == 0 && CalculationTime < Whenlong * 60) {
