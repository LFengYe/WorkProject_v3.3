...
public class ImageCycleView extends LinearLayout {
    ...
    public ImageCycleView(Context context, AttributeSet attrs) {
        ...
        LayoutInflater.from(context).inflate(cn.com.goodsowner.R.layout.view_banner_content, this);
        mBannerPager = (CycleViewPager) findViewById(cn.com.goodsowner.R.id.pager_banner);
        ...
        // 滚动图片右下指示器视图
        mGroup = (ViewGroup) findViewById(cn.com.goodsowner.R.id.viewGroup);
    }
    ...
    public void setImageResources(ArrayList<ADInfo> infoList, ImageCycleViewListener imageCycleViewListener) {
        ...
        for (int i = 0; i < imageCount; i++) {
            ...
            if (i == 0) {
                mImageViews[i].setBackgroundResource(cn.com.goodsowner.R.mipmap.icon_point_press);
            } else {
                mImageViews[i].setBackgroundResource(cn.com.goodsowner.R.mipmap.icon_point);
            }
    ...
    private final class GuidePageChangeListener implements OnPageChangeListener {
        ...
        public void onPageSelected(int index) {
            ...
            mImageIndex = index;
            index -= 1;
            mImageViews[index].setBackgroundResource(cn.com.goodsowner.R.mipmap.icon_point_press);
