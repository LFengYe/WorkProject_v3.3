...
import cn.com.caronwer.view.NameDialog;
import cn.com.caronwer.view.SelectPicPopupWindow;
import cn.com.caronwer.view.SelectSexPopupWindow;
...
public class PersonalInfoActivity extends BaseActivity {
    ...
    protected void initView() {
        ...
        HttpUtil.setImageLoader(Contants.imagehost + userInfo.getHeadIco(), civ_head, R.mipmap.touxiang_wi, R.mipmap.touxiang_wi);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.rl_name://名字
                nickDialog = NameDialog.nickDialog(PersonalInfoActivity.this);
                nickDialog.show();
                nickDialog.setOnSettingListener(new NameDialog.NickListener() {
                    @Override
            ...
            case R.id.rl_sex://性别
                ...
                break;
            case R.id.rl_address://银行卡

                Intent intent = new Intent(PersonalInfoActivity.this, BankUserActivity.class);
