...
public class MyDialog extends Dialog {
    ...
    private static MyDialog remarkDialog;
    ...
    public MyDialog(Activity activity) {
        super(activity, cn.com.goodsowner.R.style.myDialog);
    }
    ...
    public static MyDialog nickDialog(Activity activity) {
        ...
        View v = View.inflate(activity, cn.com.goodsowner.R.layout.dialog_edit, null);
        final EditText et_nick = (EditText) v.findViewById(cn.com.goodsowner.R.id.et_nick);
        Button bt_cancel = (Button) v.findViewById(cn.com.goodsowner.R.id.bt_cancel);
        Button bt_ok = (Button) v.findViewById(cn.com.goodsowner.R.id.bt_ok);
    ...
    public static MyDialog psdDialog(Activity activity) {
        ...
        View v = View.inflate(activity, cn.com.goodsowner.R.layout.dialog_psd, null);
        final EditText et_old = (EditText) v.findViewById(cn.com.goodsowner.R.id.et_old);
        final EditText et_new = (EditText) v.findViewById(cn.com.goodsowner.R.id.et_new);
        final EditText et_new1 = (EditText) v.findViewById(cn.com.goodsowner.R.id.et_new1);
        Button bt_cancel = (Button) v.findViewById(cn.com.goodsowner.R.id.bt_cancel);
        Button bt_ok = (Button) v.findViewById(cn.com.goodsowner.R.id.bt_ok);
    ...
    public static MyDialog endDialog(final Activity activity) {
        ...
        View v = View.inflate(activity, cn.com.goodsowner.R.layout.dialog_reason, null);

        final EditText et_content = (EditText) v.findViewById(cn.com.goodsowner.R.id.et_reason);
        Button bt_cancel = (Button) v.findViewById(cn.com.goodsowner.R.id.bt_cancel);
        Button bt_ok = (Button) v.findViewById(cn.com.goodsowner.R.id.bt_ok);
    ...
    public static MyDialog remarkDialog(final Activity activity,String remark) {
        remarkDialog = new MyDialog(activity);
        View v = View.inflate(activity, cn.com.goodsowner.R.layout.dialog_remark, null);
        final TextView tv_remark = (TextView) v.findViewById(cn.com.goodsowner.R.id.tv_remark);
        Button bt_know = (Button) v.findViewById(cn.com.goodsowner.R.id.bt_know);
        tv_remark.setText(remark);
        Point size = new Point();
        activity.getWindowManager().getDefaultDisplay().getSize(size);
        int width = (int) (size.x * 0.8);
        int height = (int) (size.y * 0.22);
        remarkDialog.setContentView(v);
        remarkDialog.setCancelable(true);
        Window dialogWindow = remarkDialog.getWindow();
        WindowManager.LayoutParams lp = dialogWindow.getAttributes(); // 获取对话框当前的参数值
        dialogWindow.setGravity(Gravity.CENTER);
        lp.height = height;
        lp.width = width;
    ...
    public static MyDialog selectSexDialog(final Activity activity, View.OnClickListener sexOnClick) {
        ...
        View v = View.inflate(activity, cn.com.goodsowner.R.layout.dialog_sex, null);

        Button manBtn = (Button) v.findViewById(cn.com.goodsowner.R.id.manBtn);
        Button womanBtn = (Button) v.findViewById(cn.com.goodsowner.R.id.womanBtn);
        Button cancelBtn = (Button) v.findViewById(cn.com.goodsowner.R.id.cancelBtn);
        ...
        dialogWindow.setWindowAnimations(cn.com.goodsowner.R.style.PopupAnimation); //设置窗口弹出动画
        WindowManager.LayoutParams lp = dialogWindow.getAttributes(); // 获取对话框当前的参数值
    ...
    public static MyDialog selectPicDialog(final Activity activity, View.OnClickListener picOnClick) {
        ...
        View v = View.inflate(activity, cn.com.goodsowner.R.layout.dialog_pic, null);

        Button takePhotoBtn = (Button) v.findViewById(cn.com.goodsowner.R.id.takePhotoBtn);
        Button pickPhotoBtn = (Button) v.findViewById(cn.com.goodsowner.R.id.pickPhotoBtn);
        Button cancelBtn = (Button) v.findViewById(cn.com.goodsowner.R.id.cancelBtn);
    ...
    public static MyDialog loginDialog(final Activity activity, String name, String password) {
        loginPicDialog = new MyDialog(activity, cn.com.goodsowner.R.style.fullDialog);
        View v = View.inflate(activity, cn.com.goodsowner.R.layout.dialog_login, null);
        final EditText et_account = (EditText) v.findViewById(cn.com.goodsowner.R.id.et_account);
        ...
        TextView tv_forget_psd = (TextView) v.findViewById(cn.com.goodsowner.R.id.tv_forget_psd);
        TextView tv_register = (TextView) v.findViewById(cn.com.goodsowner.R.id.tv_register);
        final Button bt_login = (Button) v.findViewById(cn.com.goodsowner.R.id.bt_login);
        CheckBox cb_eye = (CheckBox) v.findViewById(cn.com.goodsowner.R.id.cb_eye);
        RelativeLayout login_layout = (RelativeLayout) v.findViewById(cn.com.goodsowner.R.id.login_layout);
        ...
        assert dialogWindow != null;
        dialogWindow.setWindowAnimations(cn.com.goodsowner.R.style.AnimationFade); //设置窗口弹出动画
        WindowManager.LayoutParams lp = dialogWindow.getAttributes(); // 获取对话框当前的参数值
        dialogWindow.setGravity(Gravity.BOTTOM);
        lp.height = height;
        lp.width = width;
    ...
    public static MyDialog registerDialog(final Activity activity) {
        registerDialog = new MyDialog(activity, cn.com.goodsowner.R.style.fullDialog);
        View v = View.inflate(activity, cn.com.goodsowner.R.layout.dialog_register, null);
        final EditText et_account = (EditText) v.findViewById(cn.com.goodsowner.R.id.et_account);
        final EditText et_password = (EditText) v.findViewById(cn.com.goodsowner.R.id.et_password);
        ...
        RelativeLayout register_layout = (RelativeLayout) v.findViewById(cn.com.goodsowner.R.id.register_layout);
        et_account.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                int size = s.length();
                if (size != 0) {
                    bt_ok.setBackground(ContextCompat.getDrawable(activity, cn.com.goodsowner.R.drawable.button_red_bg));
                } else {
                    bt_ok.setBackground(ContextCompat.getDrawable(activity, cn.com.goodsowner.R.drawable.button_login));
                }
            }
