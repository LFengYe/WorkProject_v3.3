 ...
 */
public class ShipQueryActivity extends BaseActivity {
    private static final String TAG = "ShipQueryActivity";
    private View[] views;
            ...
            if (msg.what == 1) {
                try {
                    ...
                    if (0 == status) {
                        ...
                        Intent intent = new Intent(ShipQueryActivity.this, InquireActivity.class);
                        ...
                        MyToast.makeText(ShipQueryActivity.this, "查询失败");
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            } else {
                MyToast.makeText(ShipQueryActivity.this, "服务器异常");
            }
        }
    };
            ...
            if (msg.what == 1) {
                try {
                    ...
                    if (0 == status) {
                        ...
                        MyToast.makeText(ShipQueryActivity.this, "加载失败");
                    }
                } catch (JSONException e) {
                    Log.d(TAG, "异常——————————————————————————————");
                    e.printStackTrace();
                ...
                MyToast.makeText(ShipQueryActivity.this, msg.what + " 服务器异常");
            }
        }
    };
...
//        textViews[6] = (TextView) findViewById(R.id.S_BookingNumber);
    ...
    private void init() {
        ...
        views[0].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MyDialog myDialog = new MyDialog(ShipQueryActivity.this, 2);
        ...
        views[1].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (GlobalParams.isNetworkAvailable(ShipQueryActivity.this)) {
                    if (CompanyOk) {
                    ...
                    MyToast.makeText(ShipQueryActivity.this, "亲,网络未连接");
                }
            }
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (GlobalParams.isNetworkAvailable(ShipQueryActivity.this)) {
                    ...
                    new MyThread(Constant.URL_PostQuerySailSchedule, handler, jsonObject, ShipQueryActivity.this).start();
                } else {
                    MyToast.makeText(ShipQueryActivity.this, "亲,网络未连接");
    ...
    private void finddata() {
        if (GlobalParams.isNetworkAvailable(ShipQueryActivity.this)) {
            ...
            new MyThread(Constant.URL_PostInitShip, handler1, jsonObject, ShipQueryActivity.this).start();
    ...
    public void mydedialog(String string, final String[] strings, final int i) {
        ...
        AlertDialog dialog = new AlertDialog.Builder(ShipQueryActivity.this)
