...
public class QuerenDialog extends Dialog {
    ...
    private static QuerenDialog nickDialog;;
    public static NickListener nickListener;

    public QuerenDialog(Activity activity) {
        super(activity, R.style.MyDialog);
        this.requestWindowFeature(Window.FEATURE_NO_TITLE);
    }

    public static QuerenDialog nickDialog(Activity activity) {
        nickDialog = new QuerenDialog(activity);
        View v = View.inflate(activity, R.layout.dialog_queren, null);
