...
public class mefragmentjiedan extends android.support.v4.app.Fragment {
    ...
    private void initData() {
        ...
        allInfoAdapter = new MeAllOrderInfoAdapter(allInfos, 1);
    }

    private void findById() {
        myActivity = (MyOrderActivityMe) getActivity();
        mView = View.inflate(getActivity(), R.layout.fraagment_me_jiedan,null);
    ...
    private void getAllOrders(int PageIndex, final int ways) {
        ...
        jsonObject.addProperty("Status", 1);//表示已接单
