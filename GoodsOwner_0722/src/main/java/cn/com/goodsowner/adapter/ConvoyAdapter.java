...
public class ConvoyAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(mContext, cn.com.goodsowner.R.layout.item_my_convoy, null);
            ...
            viewHolder.rb_score = (RatingBar) convertView.findViewById(cn.com.goodsowner.R.id.rb_score);
            viewHolder.tv_time = (TextView) convertView.findViewById(cn.com.goodsowner.R.id.tv_time);
