...
import com.xys.lib_tv_fullhtml.tagsoup.HTMLSchema;
...
public class FullHtml {
    ...
    private static void withinDiv(StringBuilder out, Spanned text,
        ...
        for (int i = start; i < end; i = next) {
            ...
            for (@SuppressWarnings("unused") QuoteSpan quote : quotes) {
...
class HtmlToSpannedConverter implements ContentHandler {
    ...
    private FullHtml.ImageGetter mImageGetter;
    private FullHtml.TagHandler mTagHandler;

    public HtmlToSpannedConverter(
            String source, FullHtml.ImageGetter imageGetter, FullHtml.TagHandler tagHandler,
            Parser parser) {
        mSource = source;
    ...
    private static void startImg(SpannableStringBuilder text,
                                 Attributes attributes, FullHtml.ImageGetter img) {
        ...
        if (d == null) {
            d = Resources.getSystem().getDrawable(android.R.drawable.alert_dark_frame);
    ...
    private static void startFont(SpannableStringBuilder text,
        ...
        int sizeIndex = attributes.getIndex("size");
        String size = attributes.getValue(sizeIndex);
        int len = text.length();
    ...
    private static class Font {
        ...
        public Font(String color, String face, String size) {
            ...
            mFace = face;
            if (size != null) {
                //mSize=(Integer.parseInt(size)-4)+"";
                mSize = (Math.round(Integer.parseInt(size))) + "";
            } else {
                mSize = (Math.round(24 * 2)) + "";
            }
        }
    }
