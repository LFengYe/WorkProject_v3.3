 ...
 */
public class CarGoSetActivity extends BaseActivity {
...
//    private RelativeLayout usernameLayout;
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 1) {
                try {
                    ...
                    MyToast.makeText(CarGoSetActivity.this, jsonUser.getString("Message"));
                ...
                MyToast.makeText(CarGoSetActivity.this, "服务器异常");
            }else if (msg.what == 3) {
                // 编码异常
                Log.i(TAG, "编码异常");
            } else if (msg.what == 4) {
                ...
                // IO异常
                Log.i(TAG, "IO异常");
                MyToast.makeText(CarGoSetActivity.this, "服务器连接异常");
            }
        }
    ...
    private void initView() {
        ...
        contactLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                modifyType = 3;
                MyDialog dialog = new MyDialog(CarGoSetActivity.this, 1);
        ...
        passwordLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(CarGoSetActivity.this, ModifyPasswordActivity.class);
    ...
    private void modifyUserInfo(String modifyInfo, int modifyType) {
        ...
        if(GlobalParams.isNetworkAvailable(CarGoSetActivity.this)) {
            ...
            MyToast.makeText(CarGoSetActivity.this, "亲,网络未连接");
