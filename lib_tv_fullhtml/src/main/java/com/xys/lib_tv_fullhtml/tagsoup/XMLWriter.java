...
public class XMLWriter extends XMLFilterImpl implements LexicalHandler {
     ...
     * #forceNSDecl(String) forceNSDecl} method as well.</p>
     *
     * @param uri    The Namespace URI.
     * @param prefix The preferred prefix, or "" to select
     *               the default Namespace.
     * @see #getPrefix
     * @see #forceNSDecl(String)
     * @see #forceNSDecl(String, String)
     */
     ...
     * #setPrefix setPrefix} then {@link #forceNSDecl(String)
     * forceNSDecl}.</p>
     *
    ...
    public void startDocument()
        ...
        if (!("yes".equals(outputProperties.getProperty(OMIT_XML_DECLARATION, "no")))) {
            ...
            if (outputEncoding != null && !outputEncoding.equalsIgnoreCase("")) {
                write(" encoding=\"");
...
//		System.out.println("%%%% CDATA element");
     ...
     * @throws SAXException If there is an error writing
    ...
    private void writeAttributes(Attributes atts)
        ...
        for (int i = 0; i < len; i++) {
            ...
            if (htmlMode &&
                    booleanAttribute(atts.getLocalName(i), atts.getQName(i), atts.getValue(i)))
                break;
            write("=\"");
     ...
     *
     * @throws SAXException This method will throw
     ...
     * @throws SAXException This method will throw an
