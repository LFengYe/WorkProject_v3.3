...
public class MyOrderAdapter extends RecyclerView.Adapter<MyOrderAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        viewHolder.tv_money.setText(String.format("¥%.2f", allMoney));
        ...
        if (orderInfo.getCancelFee() > 0) {
            ...
            viewHolder.tv_money.setText(String.format("¥%.2f", orderInfo.getCancelFee()));
            ...
            switch (orderInfo.getOrderStatus()) {
                case 1:
                    if (orderInfo.getOrderType() == 3) {
                        ...
                        viewHolder.tv_money.setVisibility(View.VISIBLE);
                        if (orderInfo.getFinanceStatus() == 1) {
                            if (orderInfo.getIsToPay().equals("True")) {
                                viewHolder.bt_pay.setVisibility(View.GONE);
                                viewHolder.tv_state.setText("运费到付");
                            } else {
                                viewHolder.bt_pay.setVisibility(View.VISIBLE);
