 ...
 */
public class JiaoTonggaosu extends BaseActivity{
    private int currentPage =1;
    private static final String TAG="JiaoTonggaosu";
            ...
            if (msg.what == 1) {
                try {
                    ...
                    if (0 == status) {
                        ...
                        MyToast.makeText(JiaoTonggaosu.this, "获取失败");
                    }
                ...
                MyToast.makeText(JiaoTonggaosu.this, msg.what+" 服务器异常");
            }
        }
    };
    ...
    private void init() {
        ...
        if(GlobalParams.isNetworkAvailable(JiaoTonggaosu.this)) {
            ...
            MyToast.makeText(JiaoTonggaosu.this, "亲,网络未连接");
        }
    ...
    public void pullUnOrderList (JSONObject obj) {
        ...
        try {
            ...
            adapter = new ArrayAdapter<String>(JiaoTonggaosu.this,R.layout.text,Str);
