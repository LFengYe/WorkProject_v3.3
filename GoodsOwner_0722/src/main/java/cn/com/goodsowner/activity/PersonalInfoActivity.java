...
public class PersonalInfoActivity extends BaseActivity {
    ...
    protected int getLayout() {
        return cn.com.goodsowner.R.layout.activity_personal_info;
    }

    @Override
    protected void findById() {
        rl_address = (RelativeLayout) findViewById(cn.com.goodsowner.R.id.rl_address);
        rl_head = (RelativeLayout) findViewById(cn.com.goodsowner.R.id.rl_head);
        rl_name = (RelativeLayout) findViewById(cn.com.goodsowner.R.id.rl_name);
        rl_sex = (RelativeLayout) findViewById(cn.com.goodsowner.R.id.rl_sex);
        civ_head = (CircleImageView) findViewById(cn.com.goodsowner.R.id.civ_head);
        civ_head1 = (CircleImageView) findViewById(cn.com.goodsowner.R.id.civ_head1);
        tv_tel = (TextView) findViewById(cn.com.goodsowner.R.id.tv_tel);
        tv_tel1 = (TextView) findViewById(cn.com.goodsowner.R.id.tv_tel1);
        tv_name = (TextView) findViewById(cn.com.goodsowner.R.id.tv_name);
        tv_name1 = (TextView) findViewById(cn.com.goodsowner.R.id.tv_name1);
        tv_sex = (TextView) findViewById(cn.com.goodsowner.R.id.tv_sex);
    ...
    protected void initView() {
        ...
        HttpUtil.setImageLoader(Contants.imagehost + userInfo.getHeadIco(), civ_head, cn.com.goodsowner.R.mipmap.account2, cn.com.goodsowner.R.mipmap.account2);

        HttpUtil.setImageLoader(Contants.imagehost + userInfo.getHeadIco(), civ_head1, cn.com.goodsowner.R.mipmap.account1, cn.com.goodsowner.R.mipmap.account1);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case cn.com.goodsowner.R.id.iv_left_white:
                ...
                finish();
                break;
            case cn.com.goodsowner.R.id.rl_name:
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case cn.com.goodsowner.R.id.pickPhotoBtn:
                    ...
                    break;
                case cn.com.goodsowner.R.id.manBtn:
                    selectSexDialog.dismiss();
                    EditUserInfo("sex", "男");
                    break;
                case cn.com.goodsowner.R.id.womanBtn:
                    selectSexDialog.dismiss();
                    EditUserInfo("sex", "女");
                    break;
                default:
