...
public class QueryRuleActivity extends BaseActivity {
    ...
    protected void initView() {
        tv_title.setText(cn.com.goodsowner.R.string.query_rule);
        ...
        HttpUtil.doPost(QueryRuleActivity.this, Contants.url_obtainMessage, "obtainMessage", map, new VolleyInterface(QueryRuleActivity.this, VolleyInterface.mListener, VolleyInterface.mErrorListener) {
            @Override
