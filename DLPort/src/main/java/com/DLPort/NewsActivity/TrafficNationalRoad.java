 ...
 */
public class TrafficNationalRoad extends BaseActivity {
    private int currentPage = 1;
    private static final String TAG = "TrafficNationalRoad";
            ...
            if (msg.what == 1) {
                try {
                    ...
                    if (0 == status) {
                        ...
                        MyToast.makeText(TrafficNationalRoad.this, "获取失败");
                    }
                ...
                MyToast.makeText(TrafficNationalRoad.this, msg.what + " 服务器异常");
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.jiaotong_guodao);
        initTitle();
        init();
    }

    private void init() {
        listView = (ListView) findViewById(R.id.jiaotong_guodao_list);


        if (GlobalParams.isNetworkAvailable(TrafficNationalRoad.this)) {
            ...
            new MyThread(Constant.URL_PostGetguodao, handler, json, this).start();

        } else {
            MyToast.makeText(TrafficNationalRoad.this, "亲,网络未连接");
        }

    }

    private void initTitle() {
        TitleView titleView = (TitleView) findViewById(R.id.jiaotong_guodao_title);
        titleView.setLeftViewVisible(true);
        titleView.setMiddleTextVisible(true);
        titleView.setWineText(R.string.news2);
        titleView.setMiddleText(R.string.guodao);
    ...
    public void pullUnOrderList(JSONObject obj) {
        ...
        try {
            ...
            adapter = new ArrayAdapter<String>(TrafficNationalRoad.this, R.layout.text, Str);
