...
public class WorkbenchActivity extends BaseActivity {
    ...
    private void createView(String CrossTitle, String ColumnTitle, String BookingList) {
        ...
        for (int i = 0; i <= crossTitles.length; i++) {
            ...
            tv_params1.setMargins(0, 0, DensityUtil.dip2px(WorkbenchActivity.this, 0.5), DensityUtil.dip2px(WorkbenchActivity.this, 0.5));
    ...
    private void createContentView(String content, LinearLayout ll_vertical, LinearLayout.LayoutParams tv_params1) {
        ...
        final ImageView iv = new ImageView(WorkbenchActivity.this);
