...
public class Fragment_carlogin extends Fragment {
    public static final String TAG = "Fragment_carlogin";
    private Button Loginin;
    private TextView carSignin;
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view =inflater.inflate(R.layout.login_car,container,false);
        findById();
        init();
        return view;
    }
    ...
    private void findById() {
        Loginin = (Button) view.findViewById(R.id.login);
        carSignin = (TextView) view.findViewById(R.id.zhuce);
        et_user = (EditText) view.findViewById(R.id.et_id);
        et_password = (EditText) view.findViewById(R.id.et_password);
        autologin = (CheckBox) view.findViewById(R.id.zidong_login);
        rememberpass = (CheckBox) view.findViewById(R.id.jizhu_ps);
    ...
    private void init(){
        ...
        carSignin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
