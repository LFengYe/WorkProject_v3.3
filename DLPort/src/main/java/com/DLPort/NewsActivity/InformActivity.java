...
public class InformActivity extends BaseActivity {
                ...
                try {
                    ...
                    if (status == 0) {
                        ...
                        if (listData.length() > 0) {
                            ...
                            MyToast.makeText(InformActivity.this, getResources().getString(R.string.no_data));
                        }
                        isCompleted = true;
                    } else {
                        isCompleted = true;
    ...
    private void initView() {
        ...
        pullableListView.setOnLoadListener(new PullableListView.OnLoadListener() {
            ...
            public void onLoad(PullableListView pullableListView) {
                if (GlobalParams.isNetworkAvailable(InformActivity.this)) {
                    if (isCompleted) {
                        requestType = 2;
                        getMessageList(currentPage, pageSize);
                    } else {
                        pullableListView.finishLoading();
                        MyToast.makeText(InformActivity.this, getResources().getString(R.string.loading));
                    }
                } else {
                    pullableListView.finishLoading();
                    MyToast.makeText(InformActivity.this, getResources().getString(R.string.no_network_promote));
                }
            }
        });
    ...
    private void getMessageList(int pageIndex, int pageSize) {
        ...
        try {
            ...
            new MyThread(Constant.URL_MessagePostInform, handler, json,this).start();
        } catch (JSONException e) {
            e.printStackTrace();
        }
    }
