...
import static cn.guugoo.jiapeiteacher.R.id.change_student;
...
public class TeacherCommentActivity extends BaseActivity {
    ...
    class ClassStudentAsyncTask extends BaseAsyncTask {
        ...
        protected void dealResults(String s) {
            if (s.isEmpty()) {
                Toast.makeText(TeacherCommentActivity.this, cn.guugoo.jiapeiteacher.R.string.servlet_error, Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            if (totalData.getStatus() == 0) {
                ...
                student_name.setText(getResources().getText(cn.guugoo.jiapeiteacher.R.string.student_name) + studentDetails.getName());
                ...
                Glide.with(TeacherCommentActivity.this)
                        ...
                        .into(civ_head);
                student_sex.setText(getResources().getText(cn.guugoo.jiapeiteacher.R.string.student_sex) + studentDetails.getSex());
                student_tel.setText(getResources().getText(cn.guugoo.jiapeiteacher.R.string.student_tel) + studentDetails.getTel());
                student_cardId.setText(getResources().getText(cn.guugoo.jiapeiteacher.R.string.student_cardId) + studentDetails.getCardId());
                student_driverType.setText(getResources().getText(cn.guugoo.jiapeiteacher.R.string.student_driverType) + studentDetails.getDriverType());
                student_bookingTime.setText(getResources().getText(cn.guugoo.jiapeiteacher.R.string.student_bookingTime) + studentDetails.getBookingTime());
                student_bookingCourse.setText(getResources().getText(cn.guugoo.jiapeiteacher.R.string.student_bookingCourse) + studentDetails.getBookingAccount());
