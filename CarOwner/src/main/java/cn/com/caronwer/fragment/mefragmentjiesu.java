...
public class mefragmentjiesu extends android.support.v4.app.Fragment {
    ...
    private void initData() {
        ...
        allInfoAdapter = new MeAllOrderInfoAdapter(allInfos, 3);
    }

    private void findById() {
        myActivity = (MyOrderActivityMe) getActivity();
        mView = View.inflate(getActivity(), R.layout.fraagment_me_jiesu,null);
    ...
    private void getAllOrders(int PageIndex, final int ways) {
        ...
        jsonObject.addProperty("Status", 3);//表示已结束
