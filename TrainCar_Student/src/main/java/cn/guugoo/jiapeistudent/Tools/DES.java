...
public class DES {
    public static JSONObject encryptDES(String encryptString) {
        ...
        try {
            ...
            json.put("Parameter", new String(encode(cipher.doFinal(encryptString.getBytes("UTF-8")))));
            return json;
    ...
    public static String decryptDES(String decodeString)  {
        try {
