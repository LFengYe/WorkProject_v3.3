 ...
 */
public class CarOwnerOrderActivty extends BaseActivity {
    private static final String TAG="CarOwnerOrderActivty";
            ...
            if(msg.what ==1) {
                ...
                try {
                    ...
                    if (status == 0) {
                        ...
                        MyToast.makeText(CarOwnerOrderActivty.this, "亲、暂时没有订单");
                        isCompleated = true;
                        switch (requestType){
                            case 1:
...
//        initOrders();
        ...
        xiala.setOnRefreshListener(new PullToRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh(PullToRefreshLayout pullToRefreshLayout) {
                ...
                if (GlobalParams.isNetworkAvailable(CarOwnerOrderActivty.this)) {
                    if (isCompleated) {
                        mlist.clear();
                        adapter.notifyDataSetChanged();
                        currentPage = 1;
                        ...
                        Toast.makeText(CarOwnerOrderActivty.this, "亲,请连接网络！！！", Toast.LENGTH_SHORT)
                                .show();
                    }
                } else {
                    isCompleated = true;
    ...
    public void NetRefresh(){
        ...
        try {
            ...
            isCompleated=false;
            new MyThread(Constant.URL_PostGetMyOrder,handler,json,CarOwnerOrderActivty.this).start();
