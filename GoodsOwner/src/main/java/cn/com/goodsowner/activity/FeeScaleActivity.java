...
public class FeeScaleActivity extends BaseActivity {
    ...
    protected int getLayout() {
        return cn.com.goodsowner.R.layout.activity_fee_scale;
    }
    ...
    protected void initView() {
        tv_title.setText(cn.com.goodsowner.R.string.fee_scale);
        ...
        HttpUtil.doPost(FeeScaleActivity.this, Contants.url_obtainMessage, "obtainMessage", map, new VolleyInterface(FeeScaleActivity.this, VolleyInterface.mListener, VolleyInterface.mErrorListener) {
            @Override
