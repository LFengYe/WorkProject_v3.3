 ...
 */
public class Fragment_sginhuo extends Fragment {
    private View[] views;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.sign_in_huo,container,false);
        findById();
        init();
        return view;
    ...
    private void findById() {
        ...
        views[0]= view.findViewById(R.id.huo_click_Companyname);
        views[1]=view.findViewById(R.id.huo_click_Address);
        views[2]=view.findViewById(R.id.huo_click_Principal);
        views[3] =view.findViewById(R.id.huo_click_Telephoen);
        views[4] = view.findViewById(R.id.huo_click_LoginName);
        views[5] = view.findViewById(R.id.huo_click_PassWork);
        views[6] = view.findViewById(R.id.huo_click_Inviter);

        textViews[0]= (TextView) view.findViewById(R.id.huo_Companyname);
        textViews[1] = (TextView) view.findViewById(R.id.huo_Address);
        textViews[2] = (TextView) view.findViewById(R.id.huo_Principal);
        textViews[3] = (TextView) view.findViewById(R.id.huo_Telephoen);
        textViews[4] = (TextView) view.findViewById(R.id.huo_LoginName);
        textViews[5] = (TextView) view.findViewById(R.id.huo_PassWork);
        textViews[6] = (TextView) view.findViewById(R.id.huo_Inviter);
    }
