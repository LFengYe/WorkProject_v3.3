 ...
 */
public class GangKouYujing extends BaseActivity{
    private int currentPage =1;
    private static final String TAG="GangKouYujing";
            ...
            if (msg.what == 1) {
                try {
                    ...
                    if (0 == status) {
                        ...
                        MyToast.makeText(GangKouYujing.this, "获取失败");
                    }
                ...
                MyToast.makeText(GangKouYujing.this, msg.what+" 服务器异常");
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gangkou_yujing);
        initTitle();
        init();
    ...
    private void init() {
        listView = (ListView) findViewById(R.id.yujing_list);


        if(GlobalParams.isNetworkAvailable(GangKouYujing.this)) {
            ...
            new MyThread(Constant.URL_PostGetyujing,handler,json,GangKouYujing.this).start();

        } else{
            MyToast.makeText(GangKouYujing.this, "亲,网络未连接");
        }
        
    }

    private void initTitle() {
        TitleView titleView = (TitleView) findViewById(R.id.gangkouyujing_title);
        titleView.setLeftViewVisible(true);
        titleView.setMiddleTextVisible(true);
        titleView.setWineText(R.string.news1);
        titleView.setMiddleText(R.string.yujing);
    ...
    public void pullUnOrderList (JSONObject obj) {
        ...
        try {
            ...
            adapter = new ArrayAdapter<String>(GangKouYujing.this,R.layout.text,Str);
