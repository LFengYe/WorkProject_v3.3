 ...
 */
public class JiaoTongguodao extends BaseActivity {
    private int currentPage = 1;
    private static final String TAG = "JiaoTongguodao";
            ...
            if (msg.what == 1) {
                try {
                    ...
                    if (0 == status) {
                        ...
                        MyToast.makeText(JiaoTongguodao.this, "获取失败");
                    }
                ...
                MyToast.makeText(JiaoTongguodao.this, msg.what + " 服务器异常");
            }
        }
    };
    ...
    private void init() {
        ...
        if (GlobalParams.isNetworkAvailable(JiaoTongguodao.this)) {
            ...
            MyToast.makeText(JiaoTongguodao.this, "亲,网络未连接");
        }
    ...
    public void pullUnOrderList(JSONObject obj) {
        ...
        try {
            ...
            adapter = new ArrayAdapter<String>(JiaoTongguodao.this, R.layout.text, Str);
